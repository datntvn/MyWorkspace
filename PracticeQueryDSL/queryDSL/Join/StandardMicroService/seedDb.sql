...
insert into customer (name, company_id) values ("Boo Stoo",1);
insert into customer (name, company_id) values ("Roo Kaa",1);
insert into customer (name, company_id) values ("Koko Baba",2);
