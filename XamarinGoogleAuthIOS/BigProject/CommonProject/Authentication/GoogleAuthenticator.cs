...
namespace DatNTCommon.Authentication
{
    public class GoogleAuthenticator
    {
        ...
        public GoogleAuthenticator(string clientId, string scope, string redirectUrl, IGoogleAuthenticationDelegate authenticationDelegate)
        {
            ...
            Console.WriteLine("DEBUG:: Finished initialize auth config" + _auth.ToString());

            _auth.Completed += OnAuthenticationCompleted;
            _auth.Error += OnAuthenticationFailed;
            _auth.BrowsingCompleted += DatNTVerifyPageLoad;
        }
        ...
        /* Dat test */
        private void DatNTVerifyPageLoad(object sender, EventArgs e)
        {
            Console.WriteLine("Event of Browsing complete:: " + sender.ToString());
            return;
        }
